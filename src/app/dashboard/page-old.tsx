        ...
        <div className="mx-auto max-w-7xl px-3 sm:px-6 lg:px-8">
          <div className="flex h-14 sm:h-16 items-center justify-between">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-lg sm:text-2xl font-bold text-white">GetShortzy</span>
            </Link>
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              <div className="flex items-center gap-1 sm:gap-2 rounded-lg bg-gradient-to-r from-purple-600 to-pink-600 px-2 sm:px-4 py-1.5 sm:py-2 shadow-lg shadow-purple-500/20">
              ...
              <Link
                ...
                className="rounded-lg border border-purple-500 bg-purple-500/10 px-2 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-medium text-purple-400 hover:bg-purple-500/20 transition-colors"
              >
        ...
        <div className="mb-8">
          <div className="mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={() => setShowUploadDialog(true)}
                className="flex items-center gap-1 sm:gap-2 rounded-lg bg-purple-600 px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-white hover:bg-purple-700 transition-all hover:scale-105 shadow-lg shadow-purple-500/20 whitespace-nowrap"
              >
